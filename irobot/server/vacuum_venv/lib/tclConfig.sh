...
TCL_CC='/home/itaim/git/vacuum/vacuum_venv/bin/x86_64-conda_cos6-linux-gnu-cc'
...
# installed.
TCL_PREFIX='/home/itaim/git/vacuum/vacuum_venv'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/itaim/git/vacuum/vacuum_venv'
...
TCL_RANLIB='/home/itaim/git/vacuum/vacuum_venv/bin/x86_64-conda_cos6-linux-gnu-ranlib'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/itaim/git/vacuum/vacuum_venv/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/itaim/git/vacuum/vacuum_venv/include'
...
TCL_PACKAGE_PATH='/home/itaim/git/vacuum/vacuum_venv/lib '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/itaim/git/vacuum/vacuum_venv/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/tmp/build/80754af9/tk_1510171604075/work/tcl8.6.7/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/itaim/git/vacuum/vacuum_venv/lib/libtclstub8.6.a'
